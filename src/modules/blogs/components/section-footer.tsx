    ...
    <section className="w-[88%] lg:w-[100%] mx-auto bg-[rgb(var(--secondary-rgb))] py-4 lg:py-20 relative overflow-hidden rounded-xl mt-3">
      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 max-w-xl mx-auto h-full">
            <div className="border border-gray-100 w-full rounded-md flex justify-center items-center">
              <div className="flex flex-1 justify-start items-center ml-5 h-full bg-[rgb(var(--secondary-rgb))] rounded-md text-white opacity-80 placeholder:text-white">
                Kết bạn 0939217718
              </div>
            </div>
