        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          <div className="space-y-6">
            ...
            <p className="text-gray-400">
              Trung Tâm Tiếng Anh Từ Cơ Bản Đến Nâng Cao Tại Cần Thơ Đào tạo
              tiếng Anh cho mọi độ tuổi: tiểu học, THCS, THPT, sinh viên và học
              viên sau đại học. Giảng dạy bởi đội ngũ chuyên gia hàng đầu, giàu
              kinh nghiệm – cam kết đầu ra rõ ràng, lộ trình học hiệu quả.
            </p>
